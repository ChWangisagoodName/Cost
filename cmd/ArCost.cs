         ...
         try
            {
               ...
               // double perimeter = GetRectangularColumnPerimeter(element);//获取柱子边长  单位米
                ...
                double BeamLength = GetBeamLength(element);
                TaskDialog.Show("r", BeamLength.ToString());
                    ...
                    if (collector2.Count() > 0)
                    {
                        ...
                        foreach (var item in floorList)
                        {
                            if (item is Floor)
                            {
                                ...
                                {
                                    solid3 = BooleanOperationsUtils.ExecuteBooleanOperation(solid, solid1, BooleanOperationsType.Difference);
